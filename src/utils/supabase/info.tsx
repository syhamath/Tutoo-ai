...
// Optional: base URL for your server functions/proxy
// For MVP, prefer Cloudflare Pages Functions at /api (safer for your OpenAI key)
// You can set VITE_API_BASE=/api in your env; fallback keeps current behavior.
